...
from utils.layers import convolutional, residual_block  # , route, upsample
...
if __name__ == '__main__':
    inputs = tf.placeholder(shape=[1, 416, 416, 3], dtype=tf.float32)
    r1, r2, out = darknet53(inputs, trainable=True)
